...
struct EventsShipper {
    ...
    struct ApplicationContext: Encodable {
        ...
        var id: EventsTracker.AppIdentifier
        ...
        init(id: EventsTracker.AppIdentifier, buildNum: Int? = nil, name: String? = nil) {
            self.id = id
            
            let appBundle = Bundle.main
            
            #warning("are these json values still used? what if we send events without them?: LH - 7 Feb 2020")
            self.build = buildNum
//                ?? {
